...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        ...
        array(
            ...
            // 'default'  => '',
            'output' =>  array( 'color' => '.menu-item a:not(.current-menu-item a, .widgets a):not(:hover)' ),
            'transparent' => false,
            'required' => array(
        ...
        array(
            ...
            // 'default'  => '',
            'output' =>  array(
                'color' => '.menu-item a:not(.current-menu-item a, .widgets a):not(:hover)',
             ),
            'transparent' => false,
            'required' => array(
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'output' => array('.widgets a, .widget .menu-item a:not(.current-menu-item a):not(:hover))'),
        ),
        array(
        ...
        array(
            ...
            'output'   => array('.widget_nav_menu ul.menu>li, .widget_archive>ul>li, .widget_categories>ul>li, .widget_meta>ul>li, .widget_pages>ul>li, .widget_recent_entries>ul>li, .wp-block-archives>li, .wp-block-latest-posts:not(.is-grid)>li'),
            'default'  => array(
                'border-color'  => '#ffffff', 
                'border-style'  => 'solid', 
                //'border-top'    => '5px', 
        ...
        array(
            'id' => 'socialmedia_footer_settings',
            'type' => 'info',
            'title' => esc_html__('Redes Sociales', 'new'),
        ),
        array(
            'id' => 'footer_social_media_colors',
            'type' => 'color',
            'title' => esc_html__('Color de las redes sociales', 'new'),
            'subtitle' => esc_html__('Cambiar el color de los iconos.', 'new'),
            'output' => array('.icons i'),
        ),
        array(
            'id' => 'footer_social_media_colors_hover',
            'type' => 'color',
            'title' => esc_html__('Color Hover de las redes sociales', 'new'),
            'subtitle' => esc_html__('Cambiar el color al pasar por encima de los iconos.', 'new'),
            'output' => array('.icons i:hover'),
        ),
    )
));
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'info_excerpt_word_count',
            'type' => 'info',
            'title' => esc_html__('Otras Opciones', 'new'),
            'desc' => esc_html__('Modificación de otras diferentes opciones dentro del blog', 'new'),
        ),
        array(
            'id'       => 'excerpt_word_count',
            'type'     => 'text',
            'title'    => esc_html__( 'Longitud del Extracto (Palabras)', 'new' ),
            'subtitle' => esc_html__( 'Define el número máximo de palabras a mostrar en los extractos de blog.', 'new' ),
            'desc'     => esc_html__( 'Introducir un número entero (ej: 20).', 'new' ),
            'default'  => '20',
            'validate' => 'numeric',
        ),
